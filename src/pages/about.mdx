...
I'm a software engineer passionate about building impactful solutions. While my core focus is development, I also bring experience in digital product and content creation to the table.
...
- AI applications and chatbot development
...
- **Modern Backend Development**: Exploring powerful languages like Go, NodeJs, and Rust to build robust and efficient backend services.
- **AI-Powered Solutions**: Integrating AI technologies to enhance user experiences and automate processes.
- **Chatbot Development**: How to creating intelligent conversational interfaces that solve real business needs.
